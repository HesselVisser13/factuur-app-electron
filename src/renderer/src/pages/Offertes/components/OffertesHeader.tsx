// src/renderer/src/pages/Offertes/components/OffertesHeader.tsx
...
export function OffertesHeader({ onOpenFolder, onNew }: Props) {
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex gap-2">
        <button
          ...
          title="Open de map met alle offerte-PDF's"
